...
{{-- meta_tags --}}
@section('meta_tags')
    <meta name="description" content="Transcription Service - Audio Upload">
@endsection

{{-- title --}}
@section('title') Transcription Service - Audio Upload @endsection
...
<form id="audio-upload-form" class="d-flex justify-content-center align-items-center flex-column" action="{{ route('audio.upload') }}" method="post" enctype="multipart/form-data">
    @method('POST')
    @csrf
